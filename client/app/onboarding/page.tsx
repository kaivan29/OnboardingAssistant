  ...
  const handleFileUpload = useCallback(
    async (uploadedFiles: File[]) => {
      ...
      try {
        ...
        toast.error(
          `Error: ${errorMessage}. Please ensure the backend is running on port 8000.`
        );
  ...
  const handleConfirm = useCallback(() => {
    if (analysisResult) {
      ...
      localStorage.setItem(
        "candidateId",
        analysisResult.candidate.id.toString()
      );
    }
          ...
          <>
            <div className="max-w-2xl w-full text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                We'll analyze your experience with AI and generate a
                personalized study plan tailored to your background and
                knowledge gaps.
              </p>
            </div>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 text-xs">
                            <span className="text-gray-500">
                              {week.objectives.length} objectives
                            </span>
                          </div>
                        </div>
                      ))}
